...
class TestSQLiteTableContext(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.table_name = "test_sqlite_ctxt"
    ...
    def test_ctxt_sequential(self):
        """Two sequential context managers should both commit independently."""
        r1 = rand_row_minimal()
        r2 = rand_row_minimal()
    ...
    def test_ctxt_second_after_rollback(self):
        """Second context should work after first one rolled back."""
        r1 = rand_row_minimal()
        r2 = rand_row_minimal()
